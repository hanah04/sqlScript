...
declare @pattrack varchar(20),
	    @datacode INT=369592 --target patient data center code
declare cursor_this cursor for


select PK_psPatRegisters
 From psPatRegisters 
 where pattrantype='O' and registryno in () --source patient tracking no.

OPEN cursor_this

FETCH NEXT FROM cursor_this INTO  @pattrack
